...
class SpikingContrastiveHead(pl.LightningModule):
    ...
    def forward(self, top_level):          
        if self.FLAGS.contrast_potential:
            for _ in range(self.iters):
                self.cla_sn2(self.net2(self.cla_sn1(self.net1(self.cla_sn0(top_level)))))
                sp_out = self.cla_sn2.v
        else:
            sp_out = self.cla_sn2(self.net2(self.cla_sn1(self.net1(self.cla_sn0(top_level)))))
